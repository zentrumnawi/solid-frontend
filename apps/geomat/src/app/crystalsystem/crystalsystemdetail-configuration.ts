...
export const configurations: CrystalsystemdetailConfiguration[] = [
  {
    ...
    displayName: 'kubisch',
    description:
      'Für die Seiten gilt: a = b = c <br> Für die Winkel gilt: &alpha; = &beta; = &gamma; = 90&deg;',
    layers: [
      { name: 0, title: '&#123; . . . &#125;' },
      { name: 100, title: '&lt;100&gt;' },
      { name: 110, title: '&lt;110&gt;' },
  ...
  },
  {
    ...
    description:
      'Für die Seiten gilt: a &ne; b &ne; c <br> Für die Winkel gilt: &alpha; = &beta; = &gamma; = 90&deg;',
    layers: [
      { name: 0, title: '&#123; . . . &#125;' },
      { name: 100, title: '[100]' },
      { name: 110, title: '[010]' },
  ...
  },
  {
    ...
    description:
      'Für die Seiten gilt: a = b &ne; c <br> Für die Winkel gilt: &alpha; = &beta; = &gamma; = 90&deg;',
    layers: [
      { name: 0, title: '&#123; . . . &#125;' },
      { name: 100, title: '[001]' },
      { name: 110, title: '&lt;100&gt;' },
