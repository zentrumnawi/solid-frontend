...
function generate() {
  //lower square
  const a1 = new THREE.Vector3(-4, 8, -5);
  const a2 = new THREE.Vector3(4, 8, -5);
  const a3 = new THREE.Vector3(4, -8, -9);
  const a4 = new THREE.Vector3(-4, -8, -9);

  //upper square
  const b1 = new THREE.Vector3(-4, 8, 9);
  const b2 = new THREE.Vector3(4, 8, 9);
  const b3 = new THREE.Vector3(4, -8, 5);
  const b4 = new THREE.Vector3(-4, -8, 5);
