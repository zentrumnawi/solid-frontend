const tetragonal = generate();

function generate() {
  //lower square
  const a1 = new THREE.Vector3(-5, 7.5, -5);
  const a2 = new THREE.Vector3(5, 7.5, -5);
  const a3 = new THREE.Vector3(5, -7.5, -5);
  const a4 = new THREE.Vector3(-5, -7.5, -5);

  //upper square
  const b1 = new THREE.Vector3(-5, 7.5, 5);
  const b2 = new THREE.Vector3(5, 7.5, 5);
  const b3 = new THREE.Vector3(5, -7.5, 5);
  const b4 = new THREE.Vector3(-5, -7.5, 5);
